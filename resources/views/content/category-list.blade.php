...
@section('content')
    ...
    <div class="px-6 py-8 " >
                    ...
                    @foreach ($categoriess as $categorie)
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td>
                                ...
                                <button data-modal-target="popup-modal-{{ $categorie->id }}" data-modal-toggle="popup-modal-{{ $categorie->id }}" type="button" class="text-white bg-red-500 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center me-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-blue-800">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
        ...
        <div class="mt-4">
            {{ $categoriess->links('pagination::tailwind') }}
        </div>
